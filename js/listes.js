...
let arrCodeurDetails = [
    ...
    {
        pseudo: "palomita",
        mets: "masala dosa, guacamole",
        musique: "klezmer, jazz, chansonniers",
        activites: "La marche, la danse",
        texte: "La robote Esmeralda est conçue pour danser et faire danser sur des rythmes latinos ou klezmer."
    }
];